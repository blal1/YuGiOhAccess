...
# Game message types that need routing decisions
MSG_START = 4
MSG_DRAW = 90
MSG_NEW_TURN = 40
MSG_NEW_PHASE = 41
...
MSG_SELECT_COUNTER = 25
MSG_SELECT_SUM = 23
MSG_SELECT_UNSELECT_CARD = 24
MSG_SORT_CARD = 21
MSG_CONFIRM_CARDS = 30
MSG_SHUFFLE_HAND = 55
MSG_SHUFFLE_SET_CARD = 57
MSG_SWAP_GRAVE_DECK = 60
...
PLAYER_ROUTED_MESSAGES = {
    ...
    MSG_SORT_CARD, MSG_DRAW, MSG_CONFIRM_CARDS,
}
